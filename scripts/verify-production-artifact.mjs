...
console.log("\nKathanika Media V69 — Production Artifact Integrity Verification\n");
...
if (failures) {
  console.error(`\nV69 production artifact verification failed with ${failures} issue(s).`);
  process.exit(1);
}
console.log("\nV69 production artifact integrity verification passed.");
