...
console.log("\nKathanika Media V69 — Mobile Lighthouse Performance Verification\n");
const pkg=JSON.parse(read("package.json"));
check(pkg.name === "kathanika-media-v69-founder-identity-correction", "Package identifies V69 founder-order-correction build");
check(pkg.version === "69.0.0", "Package version is 69.0.0");
...
if(failures){console.error(`\nV69 Lighthouse verification failed with ${failures} issue(s).`);process.exit(1)}
console.log("\nV69 Lighthouse verification passed.");
