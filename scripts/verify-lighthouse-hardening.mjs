...
console.log("\nKathanika Media V66 — Mobile Lighthouse Performance Verification\n");
const pkg=JSON.parse(read("package.json"));
check(pkg.name === "kathanika-media-v66-team-behind-kathanika", "Package identifies V66 career-inquiry-fix build");
check(pkg.version === "66.0.0", "Package version is 66.0.0");
...
if(failures){console.error(`\nV66 Lighthouse verification failed with ${failures} issue(s).`);process.exit(1)}
console.log("\nV66 Lighthouse verification passed.");
