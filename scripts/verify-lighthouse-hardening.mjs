...
console.log("\nKathanika Media V67 — Mobile Lighthouse Performance Verification\n");
const pkg=JSON.parse(read("package.json"));
check(pkg.name === "kathanika-media-v67-team-layout-refinement", "Package identifies V67 career-inquiry-fix build");
check(pkg.version === "67.0.0", "Package version is 67.0.0");
...
if(failures){console.error(`\nV67 Lighthouse verification failed with ${failures} issue(s).`);process.exit(1)}
console.log("\nV67 Lighthouse verification passed.");
