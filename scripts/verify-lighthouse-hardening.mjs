...
console.log("\nKathanika Media V68 — Mobile Lighthouse Performance Verification\n");
const pkg=JSON.parse(read("package.json"));
check(pkg.name === "kathanika-media-v68-founder-order-correction", "Package identifies V68 founder-order-correction build");
check(pkg.version === "68.0.0", "Package version is 68.0.0");
...
if(failures){console.error(`\nV68 Lighthouse verification failed with ${failures} issue(s).`);process.exit(1)}
console.log("\nV68 Lighthouse verification passed.");
