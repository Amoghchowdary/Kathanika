...
console.log("\nKathanika Media V65 — Mobile Lighthouse Performance Verification\n");
const pkg=JSON.parse(read("package.json"));
check(pkg.name === "kathanika-media-v65-career-inquiry-fix", "Package identifies V65 career-inquiry-fix build");
check(pkg.version === "65.0.0", "Package version is 65.0.0");
...
if(failures){console.error(`\nV65 Lighthouse verification failed with ${failures} issue(s).`);process.exit(1)}
console.log("\nV65 Lighthouse verification passed.");
