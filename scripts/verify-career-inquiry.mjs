...
console.log("\
Kathanika Media V66 — Career Inquiry Contract Verification\
");
...
V66 career inquiry verification failed with ${failures} issue(s).`); process.exit(1); }
console.log("\
V66 Career Inquiry verification passed.");
