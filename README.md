# Kathanika Media V54 — Mobile LCP / TBT / Episode Payload Revision

Production domain: https://www.kathanika.in/

V54 targets the remaining mobile Lighthouse bottlenecks observed after V53:
...
Important: GitHub Pages controls static-asset Cache-Control TTLs. The 10-minute browser TTL reported by Lighthouse cannot be changed from repository code. V54 reduces the amount of content affected by deferring the episode library and using much smaller episode images.
